...
4. **Probabilistic Matching**. Three different supervised model are used to predict further matches among those records for the whom the automatic matching did not find N matches. The models can be trained using the [01_training.py](script/01_training.py]) script, and saved into the ./models/ folder.

For further information see the [documetation](doc/doc.ipynb).
